...
class OneDimCNN(nn.Module):
    ...
    def __init__(self, max_byte_len, d_dim=256, kernel_size=None, filters=256, dropout=0.1):
...
class SAM(nn.Module):
    ...
    def __init__(self, num_class, max_byte_len, kernel_size=None, d_dim=256, dropout=0.1, filters=256):
...
if __name__ == '__main__':
    ...
    out, score = sam(torch.from_numpy(x).long())
