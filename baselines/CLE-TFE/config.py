...
USTC_DIR = 'C:/Users/w50034968/Desktop/CLE-TFE-main/data/USTC-TFC2016/Malware/'
...
class USTCMalwareConfig(Config):
    TRAIN_DATA = USTC_DIR + r'TCP/train.npz'
    HEADER_TRAIN_DATA = USTC_DIR + r'TCP/header_train.npz'
    TEST_DATA = USTC_DIR + r'TCP/test.npz'
    HEADER_TEST_DATA = USTC_DIR + r'TCP/header_test.npz'

    TRAIN_GRAPH_DATA = USTC_DIR + r'TCP/train_graph.dgl'
    HEADER_TRAIN_GRAPH_DATA = USTC_DIR + r'TCP/header_train_graph.dgl'
    TEST_GRAPH_DATA = USTC_DIR + r'TCP/test_graph.dgl'
    HEADER_TEST_GRAPH_DATA = USTC_DIR + r'TCP/header_test_graph.dgl'

    MIX_MODEL_CHECKPOINT = r'./checkpoints/mix_model_iscx_nontor.pth'

    NUM_CLASSES = 10
    MAX_SEG_PER_CLASS = 999
    NUM_WORKERS = 5
    ...
    DIR_PATH_DICT = {k: USTC_DIR + r'TCP/' + v for k, v in zip(range(len(CLASSES)), CLASSES)}
